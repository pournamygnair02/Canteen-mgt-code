            ...
            if(mysqli_num_rows($check_cat) > 0)
            {
                $error = '<div class="alert alert-danger alert-dismissible fade show">
                        ...
                        <strong>Category Food already exist!</strong>
							...
							$sql = "INSERT INTO res_category(c_name) VALUE('".$_POST['food_name']."')";  // store the submited data ino the database :images
							mysqli_query($db, $sql); 
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="food_name" class="form-control" placeholder="eg:Breakfast">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <!-- <div class="col-md-6">

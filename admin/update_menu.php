...
{				
		if(empty($_POST['d_name'])||empty($_POST['about'])||$_POST['price']==''||$_POST['dish_name']==''||$_POST['quantity']=='')
		{	
        ...
        elseif(empty($_FILES['file']['name']))
        {
            ...
            $sql = "update dishes set c_id='$_POST[dish_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',quantity='$_POST[quantity]',status=$_POST[status],in_today_menu=$_POST[inToday] where d_id='$_GET[menu_upd]'"; 
            mysqli_query($db, $sql); 
		...
		{		
			   ...
			   {        
					...
					{				                                 
						$sql = "update dishes set c_id='$_POST[dish_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',quantity='$_POST[quantity]',img='$fnew',status=$_POST[status],in_today_menu=$_POST[in_Today] where d_id='$_GET[menu_upd]'";  
						mysqli_query($db, $sql); 
  ...
  <div class="row p-t-1">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="quantity" value="<?php echo $rows['quantity'];?>"  class="form-control">
                                                </div>
                                            </div>
</div>
                                            <!--/span-->

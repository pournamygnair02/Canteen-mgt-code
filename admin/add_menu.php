	   ...
	   {			         	
                ...
                $store = "Category_Image/dishes/".basename($fnew);                      // the path to store the upload image
					...
					{        
					    ...
					    {																																								                                 
							$sql = "INSERT INTO dishes(title,slogan,price,quantity,img,status,c_id,in_today_menu) VALUE('".$_POST['d_name']."','".$_POST['about']."','".$_POST['price']."','".$_POST['quantity']."','".$fnew."','".$_POST['status']."','".$_POST['dish_name']."',1)";  // store the submited data ino the database :images
							mysqli_query($db, $sql); 

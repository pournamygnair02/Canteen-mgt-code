...
if(isset($_POST['submit'] ))
{
	...
	$mql = "update users set username='$_POST[username]', email='$_POST[email]',phone='$_POST[phone]' where u_id='$_GET[user_upd]' ";
	mysqli_query($db, $mql);
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="username" class="form-control form-control-danger"  value="<?php  echo $newrow['username'];  ?>" placeholder="eg:Riya">
                                                    </div>
                                            </div>
                                            <!-- <div class="col-md-6">

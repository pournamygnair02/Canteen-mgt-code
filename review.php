...
if(isset($_POST['submit'])){
    ...
    $query = "SELECT * FROM review_table WHERE user_id = $user_id AND product_id = $products";
    $result = mysqli_query($db, $query);
    $row = mysqli_fetch_assoc($result);
    ...
    if ($row) {
      ...
      // Otherwise, insert a new row in the database with the rating and review
      $sql = "INSERT INTO review_table VALUES ('$user_id', '$products', '$userrating', '$userreview')";
    }
...
>>>>>>> 79934bca211cf6cf9336ddbf4f6528c8bb027d58
</html>